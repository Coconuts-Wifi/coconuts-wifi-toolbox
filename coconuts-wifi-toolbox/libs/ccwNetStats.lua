...
function ccwNetStats._getWifi(self)
  ...
  local phy 	  = nil
    ...
    if(phy and i_info['name'] and i_info['mac'] and i_info['ssid'] and i_info['type'] and i_info['channel'] and i_info['txpower'])then
      ...
      table.insert(w['wifi'], { radio=phy, channel = i_info['channel'], txpower = i_info['txpower'], type= i_info['type'], name= i_info['name'], mac = i_info['mac'], ssid = i_info['ssid'], stations = stations })
